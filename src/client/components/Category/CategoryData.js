...
const CategoryData =[
    ...
    { name: 'category2',image: p2 ,route: '/products/category2'},
    { name: 'category3',image: p3 ,route: '/products/category3'},
    { name: 'category4',image: p4 ,route: '/products/category4'},
    { name: 'category5',image: p5 , route: '/products/category5'},
    { name: 'category6',image: p6 , route: '/products/category6'},
    ]
